...
struct cprint::formatter<std::array<T, N>, char> {
...
struct cprint::formatter<std::array<int, N>, char> {
  void prefix(std::basic_ostream<char>& os) const { os << "@"; }
  void separator(std::basic_ostream<char>& os) const { os << ", "; }
  void suffix(std::basic_ostream<char>& os) const { os << "#"; }
};
...
template<typename T, std::size_t N>
struct cprint::formatter<std::array<T, N>, wchar_t> {
...
TEST_CASE( "printing array of streamable types with custom formatter on char stream", "[array][char]" )
{
...
TEST_CASE( "printing array of streamable types with custom formatter on wchar_t stream", "[array][wchar_t]" )
{
  using namespace std::string_literals;
  using namespace std::string_view_literals;
  using namespace cprint;
